...
// under ~10 min causes the fetch to abort before the response can
// come back. Vercel Pro's 800s function cap gives us headroom; this
...
const longRunAgent = new Agent({
  ...
  bodyTimeout: 900_000,
  // keepAliveTimeout: keep connections warm so back-to-back cron
  // ticks don't pay TCP setup every minute.
