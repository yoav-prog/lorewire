...
DOODLE_SUFFIX = (
    ...
    "as a backdrop, sometimes a simple gradient). Stick-figure-style characters with light clothing "
    "detail: lab coats with soft gray or pale-color fill, ties in blue or red, beards / hair in gray, "
    "round glasses with thin frames, defined eyebrows and small expressive mouths. Multiple characters "
    ...
    "interior fill, not pure white), eyes can be small dots OR small rectangles for glasses lenses, "
