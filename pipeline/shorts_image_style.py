...
DOODLE_SUFFIX = (
    ...
    "fixed template, so different stories show visibly different people. Backgrounds, props and "
    "environments can be richly detailed — this is storybook composition, not a minimalist study. "
